...
{
    public partial class FacebookDialogPage : PhoneApplicationPage
    {
        private string responseData = "";
        private uint responseErrorDetail = 0;
        private FacebookWebDialogResponseStatus responseStatus = FacebookWebDialogResponseStatus.UserCancel;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (!FacebookWebDialog.DialogInProgress)
            {
            ...
            if (!authenticationStarted)
            {
                ...
                var urlParameter = NavigationContext.QueryString["url"];
                var url = HttpUtility.UrlDecode(urlParameter);
        ...
        protected override void OnNavigatingFrom(NavigatingCancelEventArgs e)
        {
            ...
            // the start screen.
            if (FacebookWebDialog.DialogInProgress && authenticationFinished)
            {
                authenticationStarted = false;
                authenticationFinished = false;

                FacebookWebDialog.OnDialogFinished(responseData, responseStatus, responseErrorDetail);
            }
        }
        ...
        {
            responseData = "";
            responseStatus = FacebookWebDialogResponseStatus.UserCancel;
        ...
        {
            if (e.Uri.AbsoluteUri.StartsWith(FacebookWebDialog.EndUri.AbsoluteUri))
            {
                responseData = e.Uri.ToString();
                responseStatus = FacebookWebDialogResponseStatus.Success;
        ...
        private void BrowserControl_NavigationFailed(object sender, NavigationFailedEventArgs e)
        {
            ...
            responseStatus = FacebookWebDialogResponseStatus.ErrorHttp;
